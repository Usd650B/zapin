...
import { UserPlus, Eye, EyeOff, Store, ShoppingCart, Zap, ArrowRight, ShieldCheck } from 'lucide-react';
...
export default function Register() {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-sm z-10 py-8">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 text-sm font-medium mt-2">Create your professional Zapin account</p>
        </div>
        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-[2.5rem] shadow-2xl shadow-gray-200/50 p-8 border border-white">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-purple-600 to-indigo-600 text-white py-4 rounded-2xl font-bold text-sm tracking-tight hover:shadow-xl hover:shadow-purple-200 transition-all disabled:opacity-50 flex items-center justify-center space-x-2 active:scale-95 mt-2"
            >
          ...
          <div className="mt-8 pt-8 border-t border-gray-50 flex flex-col items-center">
            ...
            <div className="mt-4 flex items-center space-x-1 opacity-20">
              ...
              <span className="text-[8px] font-bold uppercase tracking-[0.2em]">Secure Data</span>
            </div>
          </div>
        </div>
      </div>
